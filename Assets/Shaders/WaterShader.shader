	...
	Properties{
		...
		[PowerSlider(4)] _FresnelExponent("Fresnel Exponent", Range(0, 40)) = 1
			...
			_SpecColor("Specular Color", Color) = (0, 0, 0, 1)
				_ReflectionMultiplier("Reflection Multiplier", Color) = (1,1,1,1)
	}
		SubShader{
			...
			#pragma surface surf SimpleSpecular alpha fullforwardshadows vertex:vert
			#pragma target 3.0
		...
		//float2 _Direction;
			...
			void surf(Input i, inout SurfaceOutput o) {
				...
				o.Emission = fresnel * _ReflectionMultiplier * fresnelColor;
			}
			ENDCG
		}
			FallBack "Standard"
